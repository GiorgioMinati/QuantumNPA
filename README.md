...
Code to do NPA in Julia. Based on [https://github.com/ewoodhead/QuantumNPA.jl.git](https://github.com/ewoodhead/QuantumNPA.jl.git), extended with additional tools to implement the [scalar extension](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.123.140503) technique. In development - names of important functions or
